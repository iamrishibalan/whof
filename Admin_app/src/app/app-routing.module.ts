...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'saloon',
        loadChildren: () => import('./pages/saloon/saloon.module').then(m => m.SaloonModule)
      },
      {
        path: 'manage-saloon',
        loadChildren: () => import('./pages/manage-saloon/manage-saloon.module').then(m => m.ManageSaloonModule)
      },
