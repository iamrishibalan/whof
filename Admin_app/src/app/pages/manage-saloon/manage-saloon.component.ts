...
@Component({
  selector: 'app-manage-saloon',
  templateUrl: './manage-saloon.component.html',
  styleUrls: ['./manage-saloon.component.scss']
})
export class ManageSaloonComponent implements OnInit {
  ...
  updateVenue() {
    ...
    if (this.name === '' || this.address === '' || this.descritions === '' || this.openTime === '' || this.closeTime === ''
      || !this.openTime || !this.closeTime || this.dish === '') {
      this.error(this.api.translate('All Fields are required'));
      return false;
    }
