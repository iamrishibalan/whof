...
@Component({
  selector: 'app-saloonservices',
  templateUrl: './saloonservices.page.html',
  styleUrls: ['./saloonservices.page.scss'],
})
export class SaloonservicesPage implements OnInit {
  ...
  foodsInfo(item) {
    ...
    this.router.navigate(['/addservice'], navData);
  }
